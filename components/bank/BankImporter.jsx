...
export default function BankImporter({ onImport, onClose }) {
    ...
    try {
      ...
      if (result.status === "success" && result.output) {
        ...
        const processed = rawData.map((row, index) => {
          ...
          const category = getFieldValue(row, ['category', 'subject', 'topic', 'section', 'area']) || "Imported";
          const difficulty = getFieldValue(row, ['difficulty', 'level', 'hard', 'complexity']) || "medium";
        ...
        // Only filter out questions that are completely empty or invalid
        const validQuestions = processed.filter(q => {
          const hasValidQuestion = q.question && q.question.trim().length > 0 && q.question !== "";
          console.log(`Question "${q.question}" is valid:`, hasValidQuestion);
            ...
            <AlertDescription>
              ...
              <div className="mt-3 space-y-2 text-sm">
                ...
                <ul className="list-disc list-inside ml-4 space-y-1">
                  ...
                  <li><strong>Other:</strong> explanation/reason, category/subject, difficulty/level, points/score</li>
                </ul>
              </div>
            </AlertDescription>
          </Alert>

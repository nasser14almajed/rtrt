...
function QuestionBankCardAR({ question, section, onEdit, onDuplicate, onDelete, index, isSelectionMode = false }) {
  return (
    <motion.div
        ...
        <CardHeader>
          <div className="flex justify-between items-start">
            <div className="flex-1">
              ...
              {question.category && (
                <p className="text-sm text-slate-500 mt-1 text-right">{question.category}</p>
              )}
            </div>
            {!isSelectionMode && (
            ...
            <div className="space-y-1 text-right">
              ...
              {question.options.length > 3 && (
                <div className="text-xs text-slate-500 text-center">
                  +{question.options.length - 3} خيارات أخرى
                </div>
              )}
            </div>
          </CardContent>
...
export default React.memo(QuestionBankCardAR);
